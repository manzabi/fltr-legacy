import choises from '../choises/en';
...
export default [
    ...
    {
        text: 'Tend to think that schools and healthcare should mostly be public services',
        choises: plus,
        domain: 'O',
        facet: 6
    },
    ...
    {
        text: 'Tend to think that schools and healthcare should mostly be private services',
        choises: minus,
        domain: 'O',
        facet: 6
    },
