...
## Build client
java -jar fltr-swagger-codegen-cli-j7.jar generate -l java -i http://localhost:8090/v2/api-docs -o /Users/koma/Desktop/fltr-slackapi-client-j7 -c ../src/main/resources/config.json
