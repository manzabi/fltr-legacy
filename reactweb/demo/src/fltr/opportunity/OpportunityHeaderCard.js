...
export default class OpportunityHeaderCard extends React.Component {
                        ...
                        <Row >
                            <Col xs={12}>
                                <div style={{paddingTop: 12.5, paddingBottom: 12.5}}>
                                    ...
                                    {tags &&
                                        <div>
                                            <OpportunityTags numberOfTags={this.props.numberOfTags} taglist={opportunity.tagList} hideEdit={true}/>
                                        </div>
                                    }
