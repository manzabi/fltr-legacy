export const agreeableness = {
    ...
    description: `Agreeable people are therefore considerate, friendly,
    ...
    They are better liked than disagreeable
    ...
    results: [
        {
            score: 'low',
            text: `The candidate score on Agreeableness is low, indicating less concern
with others' needs than with your own. People see you as tough,
critical, and uncompromising.`
        },
        {
            score: 'neutral',
            text: `The candidate level of Agreeableness is average, indicating some concern
with others' Needs, but, generally, unwillingness to sacrifice
yourself for others.`
        },
        {
            score: 'high',
            text: `The candidate high level of Agreeableness indicates a strong interest in
others' needs and well-being. They are pleasant, sympathetic, and
cooperative.`
        }
    ],
    facets: [
