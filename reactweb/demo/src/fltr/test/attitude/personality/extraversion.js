export const extraversion = {
    ...
    results: [
        {
            score: 'low',
            text: `The candidate score on Extraversion is low, indicating they are
introverted, reserved, and quiet. They enjoy solitude and solitary
activities. The candidate socializing tends to be restricted to a few close friends.`
        },
        {
            score: 'neutral',
            text: `The candidate score on Extraversion is average, indicating they are
neither a subdued loner nor a jovial chatterbox. They enjoy time with
others but also time alone.`
        },
        {
            score: 'high',
            text: `The candidate score on Extraversion is high, indicating they are
sociable, outgoing, energetic, and lively. They prefer to be around
