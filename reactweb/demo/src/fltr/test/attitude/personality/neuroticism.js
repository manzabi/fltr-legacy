export const neuroticism = {
    ...
    description: `People high in neuroticism are emotionally reactive. They
    ...
    results: [
        {
            score: 'low',
            text: `The candidate score on Neuroticism is low, indicating that they are
exceptionally calm, composed and unflappable. They do not react with
intense emotions, even to situations that most people would describe
as stressful.`
        },
        {
            score: 'neutral',
            text: `The candidate score on Neuroticism is average, indicating that the candidate level of
emotional reactivity is typical of the general population.
Stressful and frustrating situations are somewhat upsetting to they,
but they are generally able to get over these feelings and cope with
these situations.`
        },
        {
            score: 'high',
            text: `The candidate score on Neuroticism is high, indicating that they are easily
upset, even by what most people consider the normal demands of
living. People consider them to be sensitive and emotional.`
        }
    ],
    facets: [
        {
