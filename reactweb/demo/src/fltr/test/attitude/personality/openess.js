export const openess = {
    ...
    many visual or performing arts. People with low scores on openness to experience tend to have narrow, common
    interests. They prefer the plain, straightforward, and obvious over the
    complex, ambiguous, and subtle.
    The intellectual style of the
    ...
    results: [
        {
            score: 'low',
            text: `The candidate score on Openness to Experience is low, indicating they like to think in
plain and simple terms. Others describe they as down-to-earth, practical,
and conservative.`
        },
        {
            score: 'neutral',
            text: `The candidate score on Openness to Experience is average, indicating they enjoy
tradition but are willing to try new things. The candidate thinking is neither
simple nor complex. To others they appear to be a well-educated person
but not an intellectual.`
        },
        {
            score: 'high',
            text: `The candidate score on Openness to Experience is high, indicating they enjoy novelty,
variety, and change. They are curious, imaginative, and creative.`
        }
    ],
    facets: [
        {
