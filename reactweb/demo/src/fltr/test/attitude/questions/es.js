import choises from '../choises/es';

const plus = choises.plus;
const minus = choises.minus;
export default [
    {
    ...
    {
        text: 'Tiendes a pensar que la educación y la sanidad debería ser mayoritariamente pública',
        choises: plus,
        domain: 'O',
        facet: 6
    },
    ...
    {
        text: 'Tiendes a pensar que la educación y la sanidad debería ser mayoritariamente privada',
        choises: minus,
        domain: 'O',
        facet: 6
    },
