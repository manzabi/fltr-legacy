...
var buildAsProd = isProduction || isStaging || isQa;
...
var entry = {
    'app': ['./src/main.js'],
    'main': ['./sass/loader.scss'],
    // 'new': ['./sass/new/loader.scss'],
    'plugins': ['./src/plugins.js']
};

var plugins = [
    new webpack.DefinePlugin({__CLIENT__: true, __SERVER__: false, __PRODUCTION__: buildAsProd, __DEV__: !buildAsProd, 'process.env.NODE_ENV': '"' + process.env.NODE_ENV + '"', 'process.env.VERSION': '"' + process.env.VERSION + '"', 'process.env.ENV': '"' + process.env.ENV + '"', __DEVTOOLS__: devTools}),
...
module.exports = deepmerge({
    ...
    output: {
        ...
        publicPath: buildAsProd ? '/' : publicPath,
