...
module.exports = deepmerge({
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({__CLIENT__: false, __SERVER__: true, __PRODUCTION__: false, __DEV__: true, 'process.env.NODE_ENV': '"' + process.env.NODE_ENV + '"', 'process.env.ENV': '"' + process.env.ENV + '"'})
    ],
